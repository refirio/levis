...
function about()
{
    ...
    echo "<h3>Main</h3>\n";
    echo "<table summary=\"configuration for main\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>MAIN_FILE</td>\n";
    echo "<td><code>" . alt(MAIN_FILE, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>MAIN_LIBRARY_PATH</td>\n";
    echo "<td><code>" . alt(MAIN_LIBRARY_PATH, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>MAIN_APPLICATION_PATH</td>\n";
    echo "<td><code>" . alt(MAIN_APPLICATION_PATH, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>MAIN_DEFAULT_MODE</td>\n";
    echo "<td><code>" . alt(MAIN_DEFAULT_MODE, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>MAIN_DEFAULT_WORK</td>\n";
    echo "<td><code>" . alt(MAIN_DEFAULT_WORK, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>MAIN_INTERNAL_ENCODING</td>\n";
    echo "<td><code>" . alt(MAIN_INTERNAL_ENCODING, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>MAIN_CHARSET</td>\n";
    echo "<td><code>" . alt(MAIN_CHARSET, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>MAIN_TIME</td>\n";
    echo "<td><code>" . MAIN_TIME . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";

    if (DATABASE_TYPE) {
        echo "<h3>Database</h3>\n";
        echo "<table summary=\"configuration for database\">\n";
        echo "<tr>\n";
        echo "<th>Constant</th>\n";
        echo "<th>Value</th>\n";
        echo "</tr>\n";
        ...
        echo "<td><code>" . DATABASE_TYPE . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_HOST</td>\n";
        echo "<td><code>" . alt(DATABASE_HOST, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_PORT</td>\n";
        echo "<td><code>" . alt(DATABASE_PORT, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_USERNAME</td>\n";
        echo "<td><code>" . alt(DATABASE_USERNAME, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_PASSWORD</td>\n";
        echo "<td><code>**********</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_NAME</td>\n";
        echo "<td><code>" . alt(DATABASE_NAME, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_PREFIX</td>\n";
        echo "<td><code>" . alt(DATABASE_PREFIX, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_CHARSET</td>\n";
        echo "<td><code>" . alt(DATABASE_CHARSET, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_CHARSET_INPUT_FROM</td>\n";
        echo "<td><code>" . alt(DATABASE_CHARSET_INPUT_FROM, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_CHARSET_INPUT_TO</td>\n";
        echo "<td><code>" . alt(DATABASE_CHARSET_INPUT_TO, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_CHARSET_OUTPUT_FROM</td>\n";
        echo "<td><code>" . alt(DATABASE_CHARSET_OUTPUT_FROM, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_CHARSET_OUTPUT_TO</td>\n";
        echo "<td><code>" . alt(DATABASE_CHARSET_OUTPUT_TO, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_MIGRATE_PATH</td>\n";
        echo "<td><code>" . alt(DATABASE_MIGRATE_PATH, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_SCAFFOLD_PATH</td>\n";
        echo "<td><code>" . alt(DATABASE_SCAFFOLD_PATH, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_BACKUP_PATH</td>\n";
        echo "<td><code>" . alt(DATABASE_BACKUP_PATH, '-') . "</code></td>\n";
        echo "</tr>\n";
        echo "<tr>\n";
        echo "<td>DATABASE_AUTOCONNECT</td>\n";
        echo "<td><code>" . (DATABASE_AUTOCONNECT ? 'true' : 'false') . "</code></td>\n";
        echo "</tr>\n";
        echo "</table>\n";
    }

    echo "<h3>Session</h3>\n";
    echo "<table summary=\"configuration for session\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>SESSION_LIFETIME</td>\n";
    echo "<td><code>" . SESSION_LIFETIME . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>SESSION_PATH</td>\n";
    echo "<td><code>" . alt(SESSION_PATH, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>SESSION_CACHE</td>\n";
    echo "<td><code>" . alt(SESSION_CACHE, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>SESSION_AUTOSTART</td>\n";
    echo "<td><code>" . (SESSION_AUTOSTART ? 'true' : 'false') . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";

    echo "<h3>Token</h3>\n";
    echo "<table summary=\"configuration for token\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>TOKEN_SPAN</td>\n";
    echo "<td><code>" . TOKEN_SPAN . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";

    echo "<h3>Regexp</h3>\n";
    echo "<table summary=\"configuration for regexp\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>REGEXP_TYPE</td>\n";
    echo "<td><code>" . alt(REGEXP_TYPE, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";

    echo "<h3>Autoload</h3>\n";
    echo "<table summary=\"configuration for autoload\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>AUTOLOAD_MODEL</td>\n";
    echo "<td><code>" . (AUTOLOAD_MODEL ? 'true' : 'false') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>AUTOLOAD_SERVICE</td>\n";
    echo "<td><code>" . (AUTOLOAD_SERVICE ? 'true' : 'false') . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";

    echo "<h3>Page</h3>\n";
    echo "<table summary=\"configuration for page\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>PAGE_PATH</td>\n";
    echo "<td><code>" . alt(PAGE_PATH, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>PAGE_CONTROLLER</td>\n";
    echo "<td><code>" . alt(PAGE_CONTROLLER, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";

    echo "<h3>Permission</h3>\n";
    echo "<table summary=\"configuration for permission\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>PERMISSION_DIRECTORY</td>\n";
    echo "<td><code>" . alt('0' . decoct(PERMISSION_DIRECTORY), '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>PERMISSION_FILE</td>\n";
    echo "<td><code>" . alt('0' . decoct(PERMISSION_FILE), '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";

    echo "<h3>Test</h3>\n";
    echo "<table summary=\"configuration for test\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>TEST_PATH</td>\n";
    echo "<td><code>" . alt(TEST_PATH, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";

    echo "<h3>Debug</h3>\n";
    echo "<table summary=\"configuration for debug\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>DEBUG_LEVEL</td>\n";
    echo "<td><code>" . DEBUG_LEVEL . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>DEBUG_PASSWORD</td>\n";
    echo "<td><code>**********</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>DEBUG_ADDR</td>\n";
    echo "<td><code>" . alt(DEBUG_ADDR, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";

    echo "<h3>Logging</h3>\n";
    echo "<table summary=\"configuration for logging\">\n";
    echo "<tr>\n";
    echo "<th>Constant</th>\n";
    echo "<th>Value</th>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>LOGGING_PATH</td>\n";
    echo "<td><code>" . alt(LOGGING_PATH, '-') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>LOGGING_MESSAGE</td>\n";
    echo "<td><code>" . (LOGGING_MESSAGE ? 'true' : 'false') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>LOGGING_GET</td>\n";
    echo "<td><code>" . (LOGGING_GET ? 'true' : 'false') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>LOGGING_POST</td>\n";
    echo "<td><code>" . (LOGGING_POST ? 'true' : 'false') . "</code></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>LOGGING_FILES</td>\n";
    echo "<td><code>" . (LOGGING_FILES ? 'true' : 'false') . "</code></td>\n";
    echo "</tr>\n";
    echo "</table>\n";
